...
service_types_and_names = {
			   ...
			   "SOLR" : "SOLR-1",
			   "SQOOP" : "SQOOP-1" }
cm_host = "cm-master-dev2-1.xpoint.internal"
cm_port = 7180
host_list = ['cm-master-dev2-1.xpoint.internal', 'cdh-master-dev2-1.xpoint.internal', 'cdh-master-dev2-2.xpoint.internal', 'dev-edgenode-1.xpoint.internal']
cluster_name = "Dare-Dev"
cdh_version = "CDH5" # also valid: "CDH4"
cdh_version_number = "5" # also valid: 4
hive_metastore_host = "cm-master-dev2-1"
...
reports_manager_host = "cm-master-dev2-1"
reports_manager_name = "reports_manager"
reports_manager_username = "rman"
reports_manager_password = "rman" # enter password here
...
cm_repo_url =  "http://cm-master-dev2-1/parcels/cloudera-cdh5.7.centos6/"
...
def set_up_cluster():
    ...
    hive_config = { "hive_metastore_database_host" : hive_metastore_host,                     "hive_metastore_database_name" : hive_metastore_name,                     "hive_metastore_database_password" : hive_metastore_password, 	    	    "hive_metastore_database_port" : hive_metastore_database_port, 		    "hive_metastore_database_type" : hive_metastore_database_type }
    ...
    rm_rcg_config = { "headlamp_database_host" : reports_manager_host,                       "headlamp_database_name" : reports_manager_name,                       "headlamp_database_user" : reports_manager_username,                       "headlamp_database_password" : reports_manager_password,  		      "headlamp_database_type" : reports_manager_database_type }
